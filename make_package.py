...
print ("Putting hw2.tgz into \'./out\'...\n")
...
dest = './out/hw2'
pkgs = ['./src/main/java/syntax_checker', './src/main/java/vapor_code_gen']

# Clean up old code
if os.path.isdir(dest):
	# Remove old .tgz if it exists
	tgz_path = os.path.join(dest, 'hw2.tgz')
...
text_to_remove = ['package syntax_checker;', 'package parser;', 'import syntax_checker.*;', 'import parser.*;', 'package vapor_code_gen;']
...
bashCommand = "tar -cvzf hw2.tgz ./hw2"
